        ...
        for (let i = 0; i < headers.length; i++) {
            ...
            switch (colName) {
                case 'chave':
                    ...
                    break;
                case 'nome_completo':
                    newRow[i] = (dados.nome_completo || '').toString().trim().toUpperCase();
                    break;
                case 'cpf':
                    newRow[i] = dados.cpf || '';
                    break;
                ...
                case 'telefone_sem_ddd':
                    newRow[i] = (dados.telefone_sem_ddd || dados.telefone || '').toString().trim();
                    break;
                ...
                case 'justificativa':
                    ...
                    break;
                case 'cargo_funcao':
                    newRow[i] = (dados.cargo_funcao || '').toString().trim().toUpperCase();
                    break;
                case 'unidade_setor':
                    newRow[i] = (dados.unidade_setor || '').toString().trim().toUpperCase();
                    break;
                case 'tipo_acao':
